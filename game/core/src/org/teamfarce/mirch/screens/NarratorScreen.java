...
public class NarratorScreen extends AbstractScreen {
    ...
    /**
     * This is how many render frames that have to occur before the next letter is added to the
     * currentMessage
     */
    ...
    /**
     * This is the full message that is to be displayed. Will gradually be added to the above
     * variable
     */
    ...
    /**
     * The current amount of render frames since the last added letter. Reset to 0 once
     * FRAMES_PER_LETTER is exceeded
     */
    ...
    private void initStage() {
        ...
        Image background =
            new Image(new TextureRegion(Assets.loadTexture("narratorBackground.png")));
    ...
    /**
     * This method is called once a render loop. It adds to the current message if it meets the
    ...
    /**
     * This method sets the buttons text and the clickable action so that this screen can be used
